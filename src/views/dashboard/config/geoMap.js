const geoMap = [
  {
    ...
    'children': [
      ...
      { 'name': '平谷区', 'log': '117.1', 'lat': '40.13' },
      { 'name': '密云区', 'log': '116.85', 'lat': '40.37' },
      { 'name': '顺义区', 'log': '116.65', 'lat': '40.13' },
      { 'name': '通县区', 'log': '116.67', 'lat': '39.92' },
      { 'name': '怀柔区', 'log': '116.62', 'lat': '40.32' },
      { 'name': '大兴区', 'log': '116.33', 'lat': '39.73' },
      { 'name': '房山区', 'log': '115.98', 'lat': '39.72' },
      { 'name': '延庆区', 'log': '115.97', 'lat': '40.47' },
      { 'name': '昌平区', 'log': '116.2', 'lat': '40.22' }
    ]
  },
  {
    'name': '上海市',
    ...
    'children': [
      ...
      { 'name': '嘉定区', 'log': '121.24', 'lat': '31.4' },
      { 'name': '宝山区', 'log': '121.48', 'lat': '31.41' },
      { 'name': '川沙区', 'log': '121.7', 'lat': '31.19' },
      { 'name': '南汇区', 'log': '121.76', 'lat': '31.05' },
      { 'name': '奉贤区', 'log': '121.46', 'lat': '30.92' },
      { 'name': '松江区', 'log': '121.24', 'lat': '31' },
      { 'name': '金山区', 'log': '121.16', 'lat': '30.89' },
      { 'name': '青浦区', 'log': '121.1', 'lat': '31.15' },
      { 'name': '崇明区', 'log': '121.4', 'lat': '31.73' }
    ]
  },
  {
    'name': '天津市',
    ...
    'children': [
      ...
      { 'name': '宁河区', 'log': '117.83', 'lat': '39.33' },
      { 'name': '静海区', 'log': '116.92', 'lat': '38.93' },
      { 'name': '蓟县区', 'log': '117.4', 'lat': '40.05' },
      { 'name': '宝坻区', 'log': '117.3', 'lat': '39.75' },
      { 'name': '武清区', 'log': '117.05', 'lat': '39.4' }
    ]
  },
  {
    'name': '重庆市',
    ...
    'children': [
      ...
      { 'name': '綦江区', 'log': '106.56', 'lat': '29.41' },
      { 'name': '长寿区', 'log': '106.64', 'lat': '29.01' },
      { 'name': '南桐区', 'log': '107.04', 'lat': '29.86' },
      { 'name': '合川区', 'log': '106.28', 'lat': '29.26' },
      { 'name': '潼南区', 'log': '106.22', 'lat': '30.03' },
      { 'name': '铜梁区', 'log': '105.8', 'lat': '30.16' },
      { 'name': '壁山区', 'log': '106.03', 'lat': '29.86' },
      { 'name': '荣昌区', 'log': '106.21', 'lat': '29.62' },
      { 'name': '大足区', 'log': '105.59', 'lat': '29.4' },
      { 'name': '永川区', 'log': '105.71', 'lat': '29.75' },
      { 'name': '万盛区', 'log': '105.91', 'lat': '29.38' }
    ]
  },
  {
    'name': '河北省',
    ...
    'lat': '38.03',
    'children': [
      { 'name': '石家庄市', 'log': '114.48', 'lat': '38.03' },
      { 'name': '唐山市', 'log': '118.02', 'lat': '39.63' },
      { 'name': '行唐市', 'log': '114.54', 'lat': '38.42' },
      { 'name': '灵寿市', 'log': '114.38', 'lat': '38.31' },
      { 'name': '束鹿市', 'log': '115.18', 'lat': '37.94' },
      { 'name': '晋县市', 'log': '115.03', 'lat': '38.03' },
      { 'name': '藁城市', 'log': '114.84', 'lat': '38.03' },
      { 'name': '高邑市', 'log': '114.58', 'lat': '37.62' },
      { 'name': '赵县市', 'log': '114.78', 'lat': '37.76' },
      { 'name': '井陉市', 'log': '114.13', 'lat': '38.03' },
      { 'name': '获鹿市', 'log': '114.03', 'lat': '38.08' },
      { 'name': '新乐市', 'log': '114.67', 'lat': '38.33' },
      { 'name': '正定市', 'log': '114.56', 'lat': '38.13' },
      { 'name': '深泽市', 'log': '115.2', 'lat': '38.2' },
      { 'name': '无极市', 'log': '114.96', 'lat': '38.16' },
      { 'name': '赞皇市', 'log': '114.35', 'lat': '37.65' },
      { 'name': '元氏市', 'log': '114.5', 'lat': '37.74' },
      { 'name': '栾城市', 'log': '114.64', 'lat': '38.87' },
      { 'name': '平山市', 'log': '114.24', 'lat': '38.2' },
      { 'name': '邯郸市', 'log': '114.47', 'lat': '36.6' },
      { 'name': '永年市', 'log': '114.5', 'lat': '36.77' },
      { 'name': '曲周市', 'log': '114.92', 'lat': '36.78' },
      { 'name': '馆陶市', 'log': '115.4', 'lat': '36.47' },
      { 'name': '魏县市', 'log': '114.94', 'lat': '36.37' },
      { 'name': '成安市', 'log': '114.68', 'lat': '36.43' },
      { 'name': '大名市', 'log': '115.14', 'lat': '36.28' },
      { 'name': '涉县市', 'log': '113.67', 'lat': '36.57' },
      { 'name': '鸡泽市', 'log': '113.85', 'lat': '36.95' },
      { 'name': '丘县市', 'log': '115.18', 'lat': '36.84' },
      { 'name': '广平市', 'log': '114.94', 'lat': '36.49' },
      { 'name': '肥乡市', 'log': '114.8', 'lat': '36.56' },
      { 'name': '临漳市', 'log': '114.62', 'lat': '36.35' },
      { 'name': '磁县市', 'log': '114.37', 'lat': '36.37' },
      { 'name': '武安市', 'log': '114.2', 'lat': '36.7' },
      { 'name': '邢台市', 'log': '114.48', 'lat': '37.05' },
      { 'name': '柏乡市', 'log': '114.68', 'lat': '37.49' },
      { 'name': '宁普市', 'log': '114.9', 'lat': '37.62' },
      { 'name': '隆尧市', 'log': '114.75', 'lat': '37.35' },
      { 'name': '临西市', 'log': '115.5', 'lat': '36.87' },
      { 'name': '南官市', 'log': '115.37', 'lat': '37.37' },
      { 'name': '巨鹿市', 'log': '115.03', 'lat': '37.22' },
      { 'name': '任县市', 'log': '114.68', 'lat': '37.11' },
      { 'name': '沙河市', 'log': '114.52', 'lat': '36.94' },
      { 'name': '临城市', 'log': '114.5', 'lat': '37.43' },
      { 'name': '内丘市', 'log': '114.5', 'lat': '37.28' },
      { 'name': '新河市', 'log': '115.22', 'lat': '37.53' },
      { 'name': '清河市', 'log': '115.67', 'lat': '37.07' },
      { 'name': '威县市', 'log': '115.08', 'lat': '36.97' },
      { 'name': '广宗市', 'log': '115.14', 'lat': '37.06' },
      { 'name': '平乡市', 'log': '115.02', 'lat': '37.06' },
      { 'name': '南和市', 'log': '114.71', 'lat': '37' },
      { 'name': '保定市', 'log': '115.48', 'lat': '38.85' },
      { 'name': '涞水市', 'log': '115.71', 'lat': '39.39' },
      { 'name': '涿县市', 'log': '115.98', 'lat': '39.48' },
      { 'name': '定兴市', 'log': '115.78', 'lat': '39.28' },
      { 'name': '容城市', 'log': '115.86', 'lat': '39.06' },
      { 'name': '安新市', 'log': '115.92', 'lat': '38.92' },
      { 'name': '蠡县市', 'log': '115.58', 'lat': '38.49' },
      { 'name': '博野市', 'log': '115.46', 'lat': '38.46' },
      { 'name': '定县市', 'log': '114.02', 'lat': '38.52' },
      { 'name': '阜平市', 'log': '114.18', 'lat': '38.85' },
      { 'name': '唐县市', 'log': '114.97', 'lat': '38.75' },
      { 'name': '涞源市', 'log': '114.67', 'lat': '39.37' },
      { 'name': '易县市', 'log': '115.49', 'lat': '39.35' },
      { 'name': '新城市', 'log': '115.84', 'lat': '39.34' },
      { 'name': '雄县市', 'log': '116.1', 'lat': '38.98' },
      { 'name': '徐水市', 'log': '115.65', 'lat': '39.02' },
      { 'name': '高阳市', 'log': '115.78', 'lat': '38.68' },
      { 'name': '安国市', 'log': '115.3', 'lat': '38.41' },
      { 'name': '清苑市', 'log': '115.47', 'lat': '38.76' },
      { 'name': '望都市', 'log': '115.14', 'lat': '38.71' },
      { 'name': '曲阳市', 'log': '114.68', 'lat': '38.62' },
      { 'name': '完县市', 'log': '115.12', 'lat': '38.84' },
      { 'name': '满城市', 'log': '115.45', 'lat': '38.95' },
      { 'name': '张家口市', 'log': '114.87', 'lat': '40.82' },
      { 'name': '康保市', 'log': '114.6', 'lat': '41.87' },
      { 'name': '赤城市', 'log': '115.82', 'lat': '40.92' },
      { 'name': '怀来市', 'log': '115.54', 'lat': '40.4' },
      { 'name': '蔚县市', 'log': '114.53', 'lat': '39.83' },
      { 'name': '宣化市', 'log': '115.03', 'lat': '40.63' },
      { 'name': '张北市', 'log': '114.7', 'lat': '41.15' },
      { 'name': '沽源市', 'log': '115.68', 'lat': '41.68' },
      { 'name': '崇礼市', 'log': '115.25', 'lat': '40.98' },
      { 'name': '涿鹿市', 'log': '115.2', 'lat': '40.37' },
      { 'name': '阳原市', 'log': '114.15', 'lat': '40.12' },
      { 'name': '怀安市', 'log': '114.38', 'lat': '40.67' },
      { 'name': '尚义市', 'log': '113.95', 'lat': '41.05' },
      { 'name': '万全市', 'log': '114.73', 'lat': '40.84' },
      { 'name': '承德市', 'log': '117.93', 'lat': '40.97' },
      { 'name': '围场市', 'log': '117.72', 'lat': '41.95' },
      { 'name': '平泉市', 'log': '118.68', 'lat': '41.02' },
      { 'name': '宽城市', 'log': '118.47', 'lat': '40.62' },
      { 'name': '兴隆市', 'log': '117.48', 'lat': '40.42' },
      { 'name': '滦平市', 'log': '117.53', 'lat': '40.95' },
      { 'name': '隆化市', 'log': '117.7', 'lat': '41.32' },
      { 'name': '青龙市', 'log': '118.93', 'lat': '40.43' },
      { 'name': '丰宁市', 'log': '116.63', 'lat': '41.2' },
      { 'name': '秦皇岛市', 'log': '119.57', 'lat': '39.95' },
      { 'name': '迁西市', 'log': '118.3', 'lat': '40.15' },
      { 'name': '迁安市', 'log': '118.69', 'lat': '40.02' },
      { 'name': '昌黎市', 'log': '119.15', 'lat': '39.72' },
      { 'name': '卢龙市', 'log': '118.85', 'lat': '39.89' },
      { 'name': '滦南市', 'log': '118.67', 'lat': '39.49' },
      { 'name': '玉田市', 'log': '117.9', 'lat': '39.9' },
      { 'name': '唐海市', 'log': '118.54', 'lat': '39.31' },
      { 'name': '遵化市', 'log': '117.97', 'lat': '40.2' },
      { 'name': '抚宁市', 'log': '119.22', 'lat': '39.88' },
      { 'name': '乐亭市', 'log': '118.9', 'lat': '39.43' },
      { 'name': '滦县市', 'log': '118.73', 'lat': '39.74' },
      { 'name': '丰南市', 'log': '118.1', 'lat': '39.58' },
      { 'name': '丰润市', 'log': '118.13', 'lat': '39.82' },
      { 'name': '廊坊市', 'log': '116.7', 'lat': '39.53' },
      { 'name': '安次市', 'log': '116.69', 'lat': '39.52' },
      { 'name': '三河市', 'log': '117.06', 'lat': '39.97' },
      { 'name': '香河市', 'log': '117', 'lat': '39.76' },
      { 'name': '霸县市', 'log': '116.38', 'lat': '39.12' },
      { 'name': '固安市', 'log': '116.29', 'lat': '39.44' },
      { 'name': '大城市', 'log': '116.63', 'lat': '38.7' },
      { 'name': '文安市', 'log': '116.45', 'lat': '38.87' },
      { 'name': '永清市', 'log': '116.48', 'lat': '39.32' },
      { 'name': '大厂市', 'log': '116.98', 'lat': '39.98' },
      { 'name': '沧州市', 'log': '116.83', 'lat': '38.33' },
      { 'name': '黄骅市', 'log': '117.33', 'lat': '38.4' },
      { 'name': '盐山市', 'log': '117.22', 'lat': '38.07' },
      { 'name': '吴桥市', 'log': '116.37', 'lat': '37.65' },
      { 'name': '东光市', 'log': '116.52', 'lat': '37.89' },
      { 'name': '肃宁市', 'log': '115.82', 'lat': '38.43' },
      { 'name': '河间市', 'log': '116.07', 'lat': '38.45' },
      { 'name': '泊头市', 'log': '116.56', 'lat': '38.08' },
      { 'name': '交河市', 'log': '116.27', 'lat': '38.02' },
      { 'name': '青县市', 'log': '116.8', 'lat': '38.58' },
      { 'name': '海兴市', 'log': '117.85', 'lat': '38.17' },
      { 'name': '南皮市', 'log': '116.7', 'lat': '38.05' },
      { 'name': '任丘市', 'log': '116.08', 'lat': '38.72' },
      { 'name': '献县市', 'log': '116.12', 'lat': '38.2' },
      { 'name': '孟村市', 'log': '117.1', 'lat': '38.06' },
      { 'name': '衡水市', 'log': '115.72', 'lat': '37.72' },
      { 'name': '饶阳市', 'log': '115.74', 'lat': '38.24' },
      { 'name': '阜城市', 'log': '116.14', 'lat': '37.87' },
      { 'name': '景县市', 'log': '116.26', 'lat': '37.69' },
      { 'name': '枣强市', 'log': '115.72', 'lat': '37.52' },
      { 'name': '深县市', 'log': '115.56', 'lat': '38.02' },
      { 'name': '安平市', 'log': '115.5', 'lat': '38.22' },
      { 'name': '武强市', 'log': '115.96', 'lat': '38.03' },
      { 'name': '武邑市', 'log': '115.9', 'lat': '37.81' },
      { 'name': '故城市', 'log': '115.96', 'lat': '37.36' },
      { 'name': '冀县市', 'log': '115.56', 'lat': '37.59' }
    ]
  },
  {
    'name': '山西省',
    ...
    'children': [
      ...
      { 'name': '阳曲市', 'log': '112.65', 'lat': '38.05' },
      { 'name': '娄烦市', 'log': '111.78', 'lat': '38.05' },
      { 'name': '清徐市', 'log': '112.33', 'lat': '37.62' },
      { 'name': '大同市', 'log': '113.3', 'lat': '40.12' },
      ...
      { 'name': '绛县市', 'log': '111.58', 'lat': '35.48' },
      { 'name': '平陆市', 'log': '111.2', 'lat': '34.12' },
      { 'name': '永济市', 'log': '110.42', 'lat': '34.88' },
      { 'name': '万荣市', 'log': '110.83', 'lat': '110.83' },
      { 'name': '稷山市', 'log': '110.97', 'lat': '35.6' }
    ]
  },
  {
    'name': '辽宁省',
  ...
  },
  {
    ...
    'children': [
      ...
      { 'name': '厦门市', 'log': '118.1', 'lat': '24.46' },
      { 'name': '同安', 'log': '118.15', 'lat': '24.74' },
      { 'name': '南平市', 'log': '118.16', 'lat': '26.65' },
  ...
  },
  {
    ...
    'children': [
      ...
      { 'name': '汕头市', 'log': '116.69', 'lat': '23.39' },
      { 'name': '洪江', 'log': '110.38', 'lat': '21.2' },
      { 'name': '茂名', 'log': '110.88', 'lat': '21.68' },
      { 'name': '佛山市', 'log': '113.11', 'lat': '23.05' },
      { 'name': '江门市', 'log': '113.06', 'lat': '22.61' },
      { 'name': '深圳市', 'log': '114.07', 'lat': '22.62' },
      { 'name': '宝安', 'log': '113.85', 'lat': '22.58' },
      { 'name': '珠海市', 'log': '113.52', 'lat': '22.3' },
